...
%Einer von diesen Normen ist die Konditionszahl von H, ich weiß leider
%nicht welcher :/
norm_1 = z_max(H) * z_max(inv(H))
norm_2 = max(eig(H)) * max(eig(inv(H)))
norm_infty = s_max(H) * s_max(inv(H))
